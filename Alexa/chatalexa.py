...
print("I am your chatbot assistant. Please your commands starting with my name, 'Alexa'. Otherwise, you can end my services by typing 'Alexa Bye'\n")

def run_alexa():
    
    command = input(f"{user_name}: ").lower().strip()
    ...
    if "alexa play" in command:
        ...
        print(f"Alexa: Goodbye {user_name}! Feel free to use my services again!\n")
        return False
